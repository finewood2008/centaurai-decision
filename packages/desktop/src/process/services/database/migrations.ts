...
/**
 * Migration v27 -> v28: Remove local billing prototype tables
 * Billing data is supplied by upstream /api/billing/* endpoints.
 */
const migration_v28: IMigration = {
  version: 28,
  name: 'Remove local billing prototype tables',
  up: (db) => {
    ...
    console.log('[Migration v28] Removed local billing prototype tables');
  },
  down: (_db) => {
    console.warn('[Migration v28] Rollback skipped: local billing tables are no longer used.');
  },
};
...
export const ALL_MIGRATIONS: IMigration[] = [
  ...
  migration_v25, migration_v26, migration_v28,
];
